...
function DeleteItem(): ReactElement {
  return (
      ...
      <div className="h-full w-full text-center">
        <div className="flex h-full flex-col justify-between">
          ...
          <div className="mt-8 flex w-full items-center justify-between gap-4">
            ...
            <button
              type="button"
              className="w-full rounded-lg bg-white px-4 py-2 text-center text-base font-semibold text-indigo-500 text-white shadow-md transition duration-200 ease-in hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-indigo-200"
            >
              Cancel
            </button>
          </div>
