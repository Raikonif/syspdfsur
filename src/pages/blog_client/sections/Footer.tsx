...
function Footer() {
  return (
    <section className="flex w-full flex-col items-center justify-center bg-gradient-to-b from-white to-violet-700 py-12 pb-10 dark:from-black md:py-24 lg:py-32">
