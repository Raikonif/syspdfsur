...
function Landing() {
  return (
    <div className="gradient leading-normal tracking-normal text-white">
      <nav
        id="header"
        className="fixed top-0 z-30 w-full bg-violet-600/50 text-white backdrop-blur"
      >
        <div className="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between py-2">
          ...
          <div className="block pr-4 lg:hidden">
            <button
              id="nav-toggle"
              className="focus:shadow-outline flex transform items-center p-1 text-pink-800 duration-300 ease-in-out transition hover:scale-105 hover:text-gray-900 focus:outline-none"
            >
              <svg
      ...
      <div className="pt-24">
        <div className="container mx-auto flex flex-col flex-wrap items-center px-3 md:flex-row">
          ...
          <div className="flex w-full flex-col items-start justify-center text-center md:w-2/5 md:text-left">
            <p className="tracking-loose w-full uppercase">What business are you?</p>
          ...
          <div className="w-full py-6 text-center md:w-3/5">
            <img className="z-50 w-full md:w-4/5" src="hero.png" />
          </div>
        </div>
      </div>
