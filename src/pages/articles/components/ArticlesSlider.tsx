...
function ArticlesSlider({ id, description, image }: SlideProps) {
  ...
  return (
    <div className="m-10 mx-auto bg-gray-200 p-16 sm:p-24 lg:p-48">
      <div
        className="relative block items-center rounded-lg bg-gray-100 shadow-xl md:flex"
        style={{ minHeight: "19rem" }}
      >
        <div
          className="relative h-full w-full overflow-hidden rounded-t-lg md:w-2/5 md:rounded-l-lg md:rounded-t-none"
          style={{ minHeight: "19rem" }}
        >
          <img
            ...
            alt={id.toString()}
          />
          <div className="absolute inset-0 h-full w-full bg-indigo-900 opacity-75"></div>
          <div className="absolute inset-0 flex h-full w-full items-center justify-center fill-current text-white">
            <svg className="h-24 w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 239 120">
        ...
        <div className="flex h-full w-full items-center rounded-lg bg-gray-100 md:w-3/5">
          <div className="p-12 md:py-12 md:pl-16 md:pr-24">
            <p className="text-gray-600">
              <span className="text-gray-900">Missguided</span> is a UK-based fashion retailer that
              has nearly doubled in size since last year. They integrated Stripe to deliver seamless
              checkout across mobile and web for customers in 100+ countries, all while
              automatically combating fraud.
            </p>
            <a
              className="mt-3 flex items-baseline text-indigo-600 hover:text-indigo-900 focus:text-indigo-900"
              href=""
            >
        ...
        <button className="focus:shadow-outline absolute left-0 top-0 -ml-6 mt-32 h-12 w-12 rounded-full bg-white text-2xl text-indigo-600 shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none">
          <span className="block" style={{ transform: "scale(-1)" }}>
            &#x279c;
          </span>
        </button>
        <button className="focus:shadow-outline absolute right-0 top-0 -mr-6 mt-32 h-12 w-12 rounded-full bg-white text-2xl text-indigo-600 shadow-md hover:text-indigo-400 focus:text-indigo-400 focus:outline-none">
